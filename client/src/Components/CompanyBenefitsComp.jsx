...
const CompanyBenefitsComp = () => {
  return (
    <>
      <Typography sx={styles.helpInfo}>
        ¿Necesitas ayuda? Contáctanos al 0212-2087687 o escríbenos al nuestro
        krugerMotors@KRUGER.com
      </Typography>
      <Stack
      ...
      >
        <Stack sx={styles.boxes}>
          ...
          en Quito también puedes retirar tu compra en nuestra sede
        </Stack>
        ...
        <Stack sx={styles.boxes}>
          ...
          Contamos con un equipo técnico y de soporte que te asesora y acompaña
          en todo el proceso de compra para brindarte una gran experiencia
        </Stack>
      </Stack>
    </>
  );
