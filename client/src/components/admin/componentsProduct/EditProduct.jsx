...
export const EditProduct = () => {
  ...
  const editProducts = async () => {
    const { response } = await productsApi.putProductById(id, dataProducts);
  ...
  const discountsItems = allItemsDiscount?.filter(
    (item) => item.name === descuentoSelect
  );
  ...
  const featuredItems = allItemsFeatured?.filter(
    (item) => item.featuredTime === featuredSelect
  );
  ...
  const handleChange = () => {
    ...
    let discountSave =
      discountIdInForm === undefined ? "null" : discountIdInForm[0];
    ...
    let featuredSave =
      selectFeaturedInForm === undefined ? "null" : selectFeaturedInForm[0];
    const selectFeaturedIdGet =
      selectFeatured === undefined ? "null" : featuredSave;
                        ...
                        {featured.status === 204 ? (
                          ...
                          >
                            {featured.map((featuredData, item) => (
                              <MenuItem
                                key={item}
                                value={featuredData.featuredTime}
                              >
