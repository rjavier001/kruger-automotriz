...
export default function EditDiscount({ id }) {
	...
	useEffect(() => {
		const getList = async () => {
			const { response } = await productsApi.getDiscountById(id.id);
	...
	const saveDiscount = () => {
		...
		const editDiscount = async () => {
			const { response } = await productsApi.putDiscountById(id.id, dataDiscount);
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
                ...
                editDiscount(id.id, dataDiscount);
				setTimeout(() => {
